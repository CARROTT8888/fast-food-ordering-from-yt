    ...
    <div class="content">
        <div class="">
            <a href="dashboard.php" class="btn-back">
                <img src="../img/arrow-left.png" alt="Back Icon" /> Back to Dashboard
            </a>
        </div>
        ...
        <div class="form-card">
            ...
            <form id="productForm" action="add-menu.php" method="POST" enctype="multipart/form-data"
                class="styled-form">
        ...
        <p class="add-menu">
            If you want to create menu, <a href="add-menu.php">Tab Here!</a>
        </p>
    </div>
</body>
