...
<body>
    ...
    <div class="warning-container">
        ...
        <p>
            This area is reserved for customers only.<br>
            You do not have permission to access this page.
        </p>

        <p>
            Please return to the dashboard to continue managing the details.
        </p>
